...
namespace Temp\MediaConverter\Binary;
...
use Temp\MediaConverter\Binary\Exception\InvalidFileArgumentException;
use Temp\MediaConverter\Binary\Exception\RuntimeException;
